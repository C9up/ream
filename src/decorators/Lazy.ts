...
export function getLazyParams(target: object): number[] {
...
export function createLazyProxy<T extends object>(resolver: () => T): T {
  ...
  // biome-ignore lint/suspicious/noExplicitAny: Proxy target must be an object literal; T is branded at call site
