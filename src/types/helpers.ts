...
/**
 * String-keyed bag of values — the recurring HTTP-shaped objects:
 * headers, cookies, query params, route params, env vars, form fields...
 *
 * Defaults to a string→string map (the most common case, and what
 * `Record<string, string>` was being repeated for). Pass a value type
 * explicitly when needed: `Dict<unknown>`, `Dict<number>`, ...
 */
